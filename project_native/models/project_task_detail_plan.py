...
class ProjectTask(models.Model):
    ...
    detail_plan_ids = fields.One2many('project.task.detail.plan', 'task_id', 'Detail Plan List', ondelete='cascade')
...
class Project(models.Model):
    ...
    detail_plan = fields.Boolean(name="Save Detail Plan", help="Allow Save Detail Plan", default=False)
