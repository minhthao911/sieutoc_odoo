...
class WebhookLogging(models.Model):
    
    _name = 'muk_webhooks.logging'
    _description = 'Request Logs'
    ...
    def action_trigger(self):
        ...
        return action._run_action_request_multi(
    ...
    def _autovacuum_logs(self):
        limit_days = int(tools.config.get('webhook_logging_autovacuum', 30))
