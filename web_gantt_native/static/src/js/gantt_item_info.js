...
var GanttListInfo = Widget.extend({
    ...
    start: function() {
        ...
        var items_more = $('<div class="item-info"/>');
        ...
        _.each(nodes, function (node) {
            ...
            _.each(childNodes, function (child) {
                ...
                // more info
                var child_text = child['child_text'];
                var more_info_text = item_info.clone();
                if (child_text) {
                    more_info_text.text(child_text);
                    more_info_text.css({'opacity': 0.6});
                }
                items_more.append(more_info_text);
