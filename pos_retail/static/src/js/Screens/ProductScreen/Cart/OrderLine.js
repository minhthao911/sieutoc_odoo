    ...
    const RetailOrderline = (Orderline) =>
        class extends Orderline {
                ...
                if (!this.props.line.discount_has_valid && this.env.pos.config.validate_discount_change && ((this.env.pos.config.validate_discount_change_type == 'increase' && this.props.line.discount < parseFloat(newDiscount)) || (this.env.pos.config.validate_discount_change_type == 'decrease' && this.props.line.quantity > parseFloat(newDiscount)) || this.env.pos.config.validate_discount_change_type == 'both')) {
                    ...
                    if (!validate) {
                        ...
                        return this.env.pos.alert_message({
                            ...
                            body: this.env._t('You have not Permission set Discount, required request your Manager approve it.')
                        });
                    } else {
            ...
            sendInput(input) {
                ...
                this.props.line.order.trigger('update-promotion');
                this.props.line.order.trigger('update-rewards');
            }
