odoo.define('pos_retail.Report', function (require) {
    ...
    class Report extends PosComponent {
        ...
        get notShowReport() {
            if (!this.env.pos.config.report_product_summary && !this.env.pos.config.report_order_summary && !this.env.pos.config.report_payment_summary && !this.env.pos.config.report_sale_summary) {
                return true
            } else {
                return false
            }
